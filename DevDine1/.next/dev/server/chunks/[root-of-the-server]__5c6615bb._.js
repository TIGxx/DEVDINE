...
async function POST(request) {
    try {
        ...
        const { data: queueData, error: queueError } = await supabase.from("queue_counter").select("current_number, last_reset_date").eq("id", 1).maybeSingle();
        if (queueError) {
        ...
        if (!queueData) {
            ...
            if (insertError) {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Failed to initialize queue number"
                }, {
                    status: 500
                });
            }
            ...
            const { error: updateError } = await supabase.from("queue_counter").update({
            ...
            if (updateError) {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Failed to update queue number"
                }, {
                    status: 500
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5c6615bb._.js.map